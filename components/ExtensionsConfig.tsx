          ...
          {message && (
            <div
              style={{
                ...
                color: message.startsWith(t("extensions.installed", { id: "" }).split("{")[0])
                  ? "var(--accent)"
                  : "#ef4444",
              }}
            >
                  ...
                  >
                    <span
                      style={{
                        ...
                        borderRadius: 3,
                        background:
                          ext.source === "bundled" ? "var(--bg-hover)" : "rgba(37,99,235,0.1)",
                        color: ext.source === "bundled" ? "var(--text-dim)" : "var(--accent)",
                      }}
                    >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: "none",
                      position: "relative",
                      background: ext.enabled ? "var(--accent)" : "var(--bg-hover)",
              ...
              <div style={{ display: "flex", gap: 6 }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontSize: 12,
                    fontWeight: 500,
                    cursor: installing || !installPath.trim() ? "default" : "pointer",
                    borderRadius: 5,
                    border: "1px solid var(--accent)",
                    background: "var(--accent)",
                    color: "#fff",
                    opacity: installing || !installPath.trim() ? 0.5 : 1,
                  }}
                >
