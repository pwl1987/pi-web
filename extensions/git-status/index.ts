...
interface RuntimeContext {
  state: { selectedSession?: { id: string; cwd?: string; name?: string } | null; selectedCwd?: string | null };
  focusPrompt: () => void;
  openFilePanel: () => void;
...
function GitPanel({ cwd }: { cwd?: string }) {
  ...
  if (loading) {
    return React.createElement("div", { style: { padding: 16, color: "var(--text-muted)", fontSize: 13 } }, "Loading git status…");
  }
  if (!info) {
    return React.createElement("div", { style: { padding: 16, color: "var(--text-dim)", fontSize: 13 } }, "Not a git repository.");
  }

  return React.createElement("div", { style: { padding: 16, display: "flex", flexDirection: "column", gap: 8 } },
    React.createElement("div", { style: { fontSize: 14, fontWeight: 600, color: "var(--text)", display: "flex", alignItems: "center", gap: 6 } },
    ...
    React.createElement("div", { style: { display: "flex", gap: 16, fontSize: 12, color: "var(--text-muted)" } },
    ...
    actions: [
      {
        ...
        disabledReason: (ctx: RuntimeContext) => ctx.state.selectedCwd ? undefined : "No project selected",
    ...
    workspacePanels: [
      {
        ...
        title: "Git",
        order: 100,
        icon: React.createElement("svg", { width: 14, height: 14, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round", strokeLinejoin: "round" },
          React.createElement("line", { x1: 6, y1: 3, x2: 6, y2: 15 }),
          React.createElement("circle", { cx: 18, cy: 6, r: 3 }),
          React.createElement("circle", { cx: 6, cy: 18, r: 3 }),
          React.createElement("path", { d: "M18 9a9 9 0 0 1-9 9" }),
          ...
          return [
            {
              type: "text" as const,
              text: branch,
              icon: React.createElement("svg", { width: 9, height: 9, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2.4, strokeLinecap: "round", strokeLinejoin: "round" },
                React.createElement("line", { x1: 6, y1: 3, x2: 6, y2: 15 }),
                React.createElement("circle", { cx: 18, cy: 6, r: 3 }),
                React.createElement("circle", { cx: 6, cy: 18, r: 3 }),
                React.createElement("path", { d: "M18 9a9 9 0 0 1-9 9" }),
