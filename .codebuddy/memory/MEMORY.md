...
- 仍开放·需人工：S2(CSRF 非 prod 失效)、P1/P2/P4(分页/缓存/去重)、P5/P6(idle 硬上限/并发 429)、L3(re-parent 绝对路径外键)、L7(SSE 断连不 abort)、L8(重复发送不幂等)、L9(fork running 直接 destroy)。详见 REVIEW-LOOP.md §10。
